...
$actions['mark_read'] = addslashes( esc_html__( 'Mark as Read', 'arforms-form-builder' ) );
$actions['mark_unread'] = addslashes( esc_html__( 'Mark As Unread', 'arforms-form-builder' ) );
					...
					<div class="frm_settings_form">
						...
						<div id="form_entries">
							...
							<form method="get" id="list_entry_form" class="arf_list_entries_form" onsubmit="return arfliteapply_bulk_action();" style="float:left;width:98%;padding-left: 15px;">
								...
								<input type="hidden" id="arflite_entries_exclude_cols" value="<?php echo esc_attr( wp_json_encode( $exclude_from_sorting ) ); ?>"/>

								<div class="alignleft actions">
									<div class="arf_list_bulk_action_wrapper">
										<?php

											$arf_change_the_list_action_one = array( 'onchange' => 'changelistentriesaction(this.value);');
											echo $arflitemaincontroller->arflite_selectpicker_dom( 'action1', 'arf_bulk_action_one', '', '', '-1', $arf_change_the_list_action_one, $actions ); //phpcs:ignore
										?>
									</div>
								...
								<div class="alignleft actions">
									<div class="arf_list_bulk_action_wrapper">
										<?php
											...
											$arf_change_the_list_action_two = array( 'onchange' => 'changelistentriesaction(this.value);');
											echo $arflitemaincontroller->arflite_selectpicker_dom( 'action3', 'arf_inc_bulk_action_one', '', '', '', $arf_change_the_list_action_two, $actions ); //phpcs:ignore
										?>
									</div>
