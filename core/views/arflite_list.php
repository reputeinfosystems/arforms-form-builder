							...
							<div class="alignleft actions">
								<div class="arf_list_bulk_action_wrapper">
									<?php
										...
										$arf_change_the_list_action = array( 'onchange' => 'changelistaction(this.value);');
										echo $arflitemaincontroller->arflite_selectpicker_dom( 'action1', 'arf_bulk_action_one', '', '', '-1', $arf_change_the_list_action, $actions ); //phpcs:ignore
									?>
								</div>
							...
							<div class="alignleft actions2">
								<div class="arf_list_bulk_action_wrapper">
									<?php
										...
										$arf_change_the_list_action_two = array( 'onchange' => 'changelistaction(this.value);');
										echo $arflitemaincontroller->arflite_selectpicker_dom( 'action3', 'arf_bulk_action_two', '', '', '-1', $arf_change_the_list_action_two, $actions ); //phpcs:ignore
									?>
								</div>
