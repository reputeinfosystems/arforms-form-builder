					...
					<form name="frm_settings_form" method="post" enctype="multipart/form-data" class="frm_settings_form" onsubmit="return arflite_global_form_validate();">
						...
						<div id="general_settings" class="<?php echo ( 'general_settings' != $setting_tab ) ? 'display-none-cls' : 'display-blck-cls'; ?>">
							<table class="form-table">
								...
								<?php
									do_action( 'arforms_load_captcha_settings' );
								?>

								<?php if( $arforms_modules->arforms_is_module_activate( 'arforms_gcaptcha' ) ): ?>
								...
								<tr class="arfmainformfield">
									<td class="tdclass">
										<label class="lblsubtitle"><?php echo esc_html__( 'Empty Form Submission Restriction Message', 'arforms-form-builder' ); ?>&nbsp;&nbsp;<span class="arfglobalrequiredfield default-msg_require">*</span></label>
									</td>
									<td>
										<input type="text" id="arfmessageempty" name="frm_empty_msg" class="txtmodal1 arfgelsetfloatstyle" value="<?php echo esc_attr( $arflitesettings->empty_msg ); ?>"/>
										<div class="arf_tooltip_main arfgelsetfloatstyle" ><img alt='' src="<?php echo esc_url( ARFLITEIMAGESURL ); ?>/tooltips-icon.png" alt="?" class="arfhelptip default-msg-toltip" title="<?php echo esc_html__( 'Message will be displayed when form is submitted without filling up any of its fields.', 'arforms-form-builder' ); ?>"/></div>
										<div class="arflite-clear-float"></div>
										<div class="arferrmessage display-none-cls" id="arferrormessageempty"><?php echo esc_html__( 'This field cannot be blank.', 'arforms-form-builder' ); ?></div>
									</td>
								</tr>
								...
								<tr>
									<td class="tdclass genenal-setlbl-padding" valign="top"><label class="lblsubtitle"><?php echo esc_html__( 'Disable IP logging', 'arforms-form-builder' ); ?></label> </td>
									<td valign="top" class="arfhidden_captcha-td">
										<div class="arf_custom_checkbox_div">
											<div class="arf_custom_checkbox_wrapper">
												<?php $arf_iplogging = isset($arflitesettings->arfmainformiplogging) ? intval($arflitesettings->arfmainformiplogging) : 0 ?>
												<input type="checkbox" name="frm_arfmainformiplogging" id="arfmainformiplogging" value="1" <?php checked( $arf_iplogging, 1 ); ?> />
												<svg width="18px" height="18px">
													<?php echo ARFLITE_CUSTOM_UNCHECKED_ICON; //phpcs:ignore ?>
													<?php echo ARFLITE_CUSTOM_CHECKED_ICON; //phpcs:ignore ?>
												</svg>
											</div>
											<span class="arf_gerset_checkoption"><label for="arfmainformiplogging"><?php echo esc_html__( 'Yes', 'arforms-form-builder' ); ?></label></span>
										</div>
									</td>
								</tr>
