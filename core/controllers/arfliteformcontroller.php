								...
								if ( apply_filters( 'arflite_check_for_draw_outside', false, $field ) ) {
									...
									foreach ( $field['options'] as $opt_key => $opt ) {
										...
										if ( ! isset( $atts ) || ! isset( $atts['label'] ) || $atts['label'] ) {
											...
											$return_string .= '<input type="checkbox" name="' . $field_name . '[]" data-type="checkbox" id="field_' . $field['id'] . '-' . $opt_key . '-' . $arflite_data_uniq_id . '" value="' . esc_attr( $field_val ) . '" data-label="'.esc_attr($opt).'" ' . $checked;
                                    ...
                                    if( true == $use_separate_value ){
										$return_string .= "<input type='hidden' class='arf_label_checkbox_hidden' name='_{$field_name}' />";
									}
								}
								$return_string .= $field_standard_tooltip;
								$return_string .= $field_description;
