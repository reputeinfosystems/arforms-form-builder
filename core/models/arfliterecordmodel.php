...
class arfliterecordmodel {
	...
	function arflitecreate( $values, $return_values = false ) {
		...
		$fields = apply_filters( 'arforms_remove_captcha_fields_for_validation', $fields, $form_id );
		...
		$arf_arfmainformiplogging = $arformsmain->arforms_get_settings( 'arfmainformiplogging', 'general_settings' );

		$new_values['ip_address'] = ( 1 != $arf_arfmainformiplogging && isset( $_SERVER['REMOTE_ADDR'] ) ) ? sanitize_text_field($_SERVER['REMOTE_ADDR']) : '';
