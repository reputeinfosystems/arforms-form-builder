 ...
 */
namespace Arforms\Monolog\Handler;

use Arforms\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Arforms\Monolog\Logger;
use Arforms\Monolog\Formatter\FormatterInterface;
use Arforms\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Arforms\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Arforms\Elasticsearch\Client;
use Arforms\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Arforms\Elastic\Elasticsearch\Client as Client8;
/**
