...
use Arforms\Monolog\Formatter\LineFormatter;
use Arforms\Monolog\Formatter\FormatterInterface;
use Arforms\Monolog\Logger;
use Arforms\Monolog\Utils;
use Arforms\PhpConsole\Connector;
use Arforms\PhpConsole\Handler as VendorPhpConsoleHandler;
use Arforms\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('Arforms\PhpConsole\Connector')) {
