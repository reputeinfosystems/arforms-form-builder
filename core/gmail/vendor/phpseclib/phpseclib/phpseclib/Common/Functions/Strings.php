 ...
 */
namespace Arforms\phpseclib3\Common\Functions;

use Arforms\ParagonIE\ConstantTime\Base64;
use Arforms\ParagonIE\ConstantTime\Base64UrlSafe;
use Arforms\ParagonIE\ConstantTime\Hex;
use Arforms\phpseclib3\Math\BigInteger;
use Arforms\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
