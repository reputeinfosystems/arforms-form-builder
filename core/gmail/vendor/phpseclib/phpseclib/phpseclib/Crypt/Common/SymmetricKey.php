...
use Arforms\phpseclib3\Exception\BadDecryptionException;
use Arforms\phpseclib3\Exception\BadModeException;
use Arforms\phpseclib3\Exception\InconsistentSetupException;
...
use Arforms\phpseclib3\Math\BinaryField;
use Arforms\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
