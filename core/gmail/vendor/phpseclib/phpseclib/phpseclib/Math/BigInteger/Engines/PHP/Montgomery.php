 ...
 */
namespace Arforms\phpseclib3\Math\BigInteger\Engines\PHP;

use Arforms\phpseclib3\Math\BigInteger\Engines\Engine;
use Arforms\phpseclib3\Math\BigInteger\Engines\PHP;
use Arforms\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
