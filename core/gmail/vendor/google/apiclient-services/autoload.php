...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('Arforms\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['Arforms\Google\Client' => 'Google_Client', 'Arforms\Google\Service' => 'Google_Service', 'Arforms\Google\Service\Resource' => 'Google_Service_Resource', 'Arforms\Google\Model' => 'Google_Model', 'Arforms\Google\Collection' => 'Google_Collection'];
