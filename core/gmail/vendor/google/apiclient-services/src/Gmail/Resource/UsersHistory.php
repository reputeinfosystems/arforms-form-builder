...
use Arforms\Google\Service\Gmail\ListHistoryResponse;
/**
 ...
 *  </code>
 */
class UsersHistory extends \Arforms\Google\Service\Resource
{
    /**
...
class_alias(UsersHistory::class, 'Arforms\Google_Service_Gmail_Resource_UsersHistory');
