 ...
 */
namespace Arforms\Google\Http;

use Arforms\Google\Auth\HttpHandler\HttpHandlerFactory;
use Arforms\Google\Service\Exception as GoogleServiceException;
use Arforms\Google\Task\Runner;
use Arforms\GuzzleHttp\ClientInterface;
use Arforms\GuzzleHttp\Exception\RequestException;
use Arforms\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (interface_exists('Arforms\GuzzleHttp\Message\ResponseInterface') && $response instanceof \Arforms\GuzzleHttp\Message\ResponseInterface) {
