 ...
 * the License.
 */
namespace Arforms\Google\Task;

use Arforms\Composer\Script\Event;
use InvalidArgumentException;
use Arforms\Symfony\Component\Filesystem\Filesystem;
use Arforms\Symfony\Component\Finder\Finder;
class Composer
{
    /**
