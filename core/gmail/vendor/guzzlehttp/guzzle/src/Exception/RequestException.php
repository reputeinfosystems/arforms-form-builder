...
use Arforms\GuzzleHttp\BodySummarizerInterface;
use Arforms\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    {
        \Arforms\trigger_deprecation('guzzlehttp/guzzle', '7.11', '%s::wrapException() is deprecated and will be removed in 8.0. Create a %s directly instead.', self::class, self::class);
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \Arforms\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
