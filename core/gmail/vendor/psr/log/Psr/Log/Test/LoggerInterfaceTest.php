...
namespace Arforms\Psr\Log\Test;

use Arforms\Psr\Log\LoggerInterface;
use Arforms\Psr\Log\LogLevel;
use Arforms\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Arforms\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Arforms\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Arforms\Psr\Log\Test\DummyTest', array('__toString'));
        }
